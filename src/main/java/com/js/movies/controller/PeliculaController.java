...
public class PeliculaController {
    ...
    public @ResponseBody Respuesta savePelicula(@RequestBody Pelicula pelicula,
                                                @RequestHeader(name = "genero") Integer genero,
                                                @RequestHeader(name = "idioma") Integer idioma) {
        Respuesta respuesta = new Respuesta();
        try {
            Boolean estado = this.peliculaServicio.savePelicula(pelicula, genero, idioma);
