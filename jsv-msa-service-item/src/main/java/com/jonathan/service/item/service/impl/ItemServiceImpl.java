...
public class ItemServiceImpl implements ItemService {
    ...
    public List<Item> findAll() {
        List<Product> products = Arrays.asList(clientRestTemplate.getForObject("http://localhost:8080/product", Product[].class));
    ...
    public Item findById(Long id, Integer amount) {
        ...
        Product product = clientRestTemplate.getForObject("http://localhost:8080/product/{id}", Product.class, pathVariable);
